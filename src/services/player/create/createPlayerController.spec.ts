...
describe("Create player controller", () => {
  ...
  it("should be able to create a new player", async () => {
    const user = await request(app).post("/users").send({
      username: "test-integration-create-player",
      email: "test-integration-create-player@example.com",
      password: "test123",
    });
  ...
  it("should not be able to create a new player if team not found", async () => {
    const user = await request(app).post("/users").send({
      username: "test-integration-create-player",
      email: "test-integration-create-player@example.com",
      password: "test123",
  ...
  it("should not be able to create a new player if position not found", async () => {
    const user = await request(app).post("/users").send({
      username: "test-integration-create-player",
      email: "test-integration-create-player@example.com",
      password: "test123",
  ...
  it("should not be able to create a new player if user not found", async () => {
    const user = await request(app).post("/users").send({
      username: "test-integration-create-player",
      email: "test-integration-create-player@example.com",
      password: "test123",
